...
tf.compat.v1.flags.DEFINE_integer('max_seq_len', 21, "")
...
class DeliveryClassifyModel(keras.models.Model):
    ...
    def __init__(self):
        ...
        self.transformer_block = TransformerBlock(128, 8, 512)
        # DNN部分
    ...
    def call(self, x):
        ...
        transformer_output = self.transformer_block(fea, None)

        fea = keras.layers.Flatten()(transformer_output)
